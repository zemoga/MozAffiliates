...
var MonthPicker = {
	...
	addEventListeners: function(){
		...
		// set current month
		MonthPicker.currentMonth = parseInt($('.month-picker ul li.current-month a').attr('title')) || 01;

		// set current year
		MonthPicker.currentYear = parseInt($('.month-picker .year-picker .current-year').text()) || 2011;
